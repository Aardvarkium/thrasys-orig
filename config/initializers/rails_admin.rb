...
# RailsAdmin config file. Generated on October 30, 2011 22:45
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Thrasys', 'Admin']
  ...
  # config.excluded_models << [Solution, Technology]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models << [Solution, Technology]
